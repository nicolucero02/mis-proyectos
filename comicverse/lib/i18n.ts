...
export const dictionary = {
  es: {
    ...
    home: {
      ...
      latestDescription:
        "Tarjetas con cubiertas visuales, firma, categoría y fecha.",
      ...
      newsletterDescription:
        "Recibí una edición breve con notas, recomendaciones y contexto para leer cómics con más criterio, sin ruido ni relleno.",
  ...
  en: {
    ...
    home: {
      ...
      latestDescription:
        "Cards with visual covers, bylines, categories, and dates.",
      ...
      newsletterDescription:
        "Get a short issue with notes, recommendations, and context to read comics with better judgment—no noise, no filler.",
